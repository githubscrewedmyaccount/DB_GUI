# Description
Small GIUI software for interfacing with Local DB, Irrelevant for non employees since you wont be able to connect without being on the network.
